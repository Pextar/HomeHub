...
var collections = []collection{
	...
	mapCollection("upnp renderers", "UPnP", upnpFile, func(s *Store) *map[string]*UPnPRenderer { return &s.UPnP }),
	...
	// every other collection. Same exception as readings, same reason.
