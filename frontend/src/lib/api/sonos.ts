...
export const sonosApi = {
  ...
  sonosStatus() {
    return req<SonosStatus>("/sonos/status");
  },
  sonosDiscover() {
    return req<SonosCandidate[]>("/sonos/discover");
  },
  sonosEventHealth() {
    return req<SonosEventHealth>("/sonos/events");
  },
  ...
  sonosEventRetry() {
    return req<{ ok: boolean }>("/sonos/events/retry", { method: "POST" });
  },
  ...
  sonosUpdateSpeaker(id: string, body: { ip?: string; name?: string; room?: string }) {
    return req<SonosSpeaker>(`/sonos/speakers/${encodeURIComponent(id)}`, {
      method: "PUT",
      body: json(body),
    });
  },
  ...
  sonosUpdateSettings(id: string, patch: SonosSettingsPatch) {
    return req<void>(`/sonos/${encodeURIComponent(id)}/settings`, {
      method: "PUT",
      body: json(patch),
    });
  },
  ...
  sonosPlay(id: string) {
    return req<void>(`/sonos/${encodeURIComponent(id)}/play`, { method: "POST" });
  },
  sonosPause(id: string) {
    return req<void>(`/sonos/${encodeURIComponent(id)}/pause`, { method: "POST" });
  },
  sonosNext(id: string) {
    return req<void>(`/sonos/${encodeURIComponent(id)}/next`, { method: "POST" });
  },
  sonosPrevious(id: string) {
    return req<void>(`/sonos/${encodeURIComponent(id)}/previous`, { method: "POST" });
  },
  sonosSetVolume(id: string, level: number, group = false) {
    return req<void>(`/sonos/${encodeURIComponent(id)}/volume`, {
      method: "PUT",
      body: json({ level, group }),
    });
  },
  sonosSetMute(id: string, muted: boolean) {
    return req<void>(`/sonos/${encodeURIComponent(id)}/mute`, {
      method: "PUT",
      body: json({ muted }),
    });
  },
  sonosJoin(id: string, targetId: string) {
    return req<void>(`/sonos/${encodeURIComponent(id)}/join`, {
      method: "POST",
      body: json({ target_id: targetId }),
    });
  },
  sonosLeave(id: string) {
    return req<void>(`/sonos/${encodeURIComponent(id)}/leave`, { method: "POST" });
  },
  ...
  sonosGroup(id: string, body: { join?: string[]; leave?: string[] }) {
    return req<void>(`/sonos/${encodeURIComponent(id)}/group`, {
      method: "POST",
      body: json(body),
    });
  },
  sonosFavorites(id: string) {
    return req<SonosFavorite[]>(`/sonos/${encodeURIComponent(id)}/favorites`);
  },
  sonosPlayFavorite(id: string, fav: SonosFavorite) {
    return req<void>(`/sonos/${encodeURIComponent(id)}/favorites/play`, {
      method: "POST",
      body: json(fav),
    });
  },
  ...
  sonosSeek(id: string, position: string) {
    return req<void>(`/sonos/${encodeURIComponent(id)}/seek`, {
      method: "PUT",
      body: json({ position }),
    });
  },
  ...
  sonosSetPlayMode(id: string, shuffle: boolean, repeat: SonosRepeat) {
    return req<void>(`/sonos/${encodeURIComponent(id)}/playmode`, {
      method: "PUT",
      body: json({ shuffle, repeat }),
    });
  },
  sonosSetCrossfade(id: string, enabled: boolean) {
    return req<void>(`/sonos/${encodeURIComponent(id)}/crossfade`, {
      method: "PUT",
      body: json({ enabled }),
    });
  },
  ...
  sonosSetAutoplay(id: string, enabled: boolean) {
    return req<void>(`/sonos/${encodeURIComponent(id)}/autoplay`, {
      method: "PUT",
      body: json({ enabled }),
    });
  },
  ...
  sonosQueue(id: string) {
    return req<SonosQueueItem[]>(`/sonos/${encodeURIComponent(id)}/queue`);
  },
  sonosQueueAdd(
    id: string,
  ...
  sonosPlayItem(id: string, body: PlayItemBody) {
    return req<void>(`/sonos/${encodeURIComponent(id)}/play-item`, {
      method: "POST",
      body: json(body),
    });
  },
