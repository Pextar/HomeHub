<script lang="ts">
    ...
    import { SEARCH_KINDS as KINDS, rowSub } from "../../lib/music/catalog";
...
<style>
    ...
    @media (prefers-reduced-motion: reduce) {
        ...
        /* The JS-driven transitions above are gated by `dur()`; this one
           is CSS and is gated here. Collapsed, not removed: the state it
           animates into is the state either way. The dock's own "said"
           flash is gated the same way inside PanelSearchDock. */
        .browse.full .s-results {
